...
//elements from address information page
	//span[text()='Former Nationality']
	//input[@id='former_nationality_search']
	//ul[@id='ul_former_nationality']//li[text()='Andorra']   //give rquired nationality into text
	//input[@id='nationalityText']
	//input[@id='email']
	...
	//input[@id='city']
	//input[@id='state']
	//input[@id='mailing_country'
	//span[text()='Address Type']
	//li[text()='Present Address']   //give as required present or permanent address
	//div[@id='nav-address']//input[@value='Previous']
	//div[@id='nav-address']//button[text()='Save & Continue']
	
// element id for emergency contact
	//input[@id='emergency_firstname']
	//input[@id='emergency_lastname']
