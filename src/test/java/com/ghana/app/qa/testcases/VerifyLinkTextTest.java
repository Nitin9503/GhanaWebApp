	    ...
	    String Link =element ;
	      ...
	      switch(Link) {
	         case "Home" :
	            ...
	            break;
	         case "Immigration" :
	        	 Assert.assertEquals(Lt.getImigrationText(), "Important Immigration Notice");
	            System.out.println("Well done");
	            break;
	         case "Consular Services" :
	        	 Assert.assertEquals(Lt.getConsularSerText(), "Introduction to Consular Services");
	         ...
	         case "Required Documents" :
	        	 Assert.assertEquals(Lt.getRequirementText(), "Basic Requirements");
		            System.out.println("Better try again");
		            break;
	         default :
